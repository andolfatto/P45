...
w_k = np.zeros(n_act)
v_k = np.zeros(n_act)
#L1=7.236325303312720e-01
#L2=3.599267695542386e+04
L1 = 0.2075
L2 = 1927.4
...
for step in range(int(np.shape(steps)[0])):
...
np.savetxt('uf.dat', np.append(tv*1000,trace[0]*1e9).reshape(2,np.size(tv)).transpose())
np.savetxt('utruef.dat', np.append(tv*1000,tracetrue[0]*1e9).reshape(2,np.size(tv)).transpose())
np.savetxt('udf.dat', np.append(tv*1000,tracevel[0]*1e9).reshape(2,np.size(tv)).transpose())
np.savetxt('udtruef.dat', np.append(tv*1000,traceveltrue[0]*1e9).reshape(2,np.size(tv)).transpose())
