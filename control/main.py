...
#embed()
np.savetxt('15u1.dat', np.append(tv*1000,trace[0]*1e9).reshape(2,np.size(tv)).transpose())
np.savetxt('15ref1.dat', np.append(tv*1000,ref[0,:]*1e9).reshape(2,np.size(tv)).transpose())
np.savetxt('15u2.dat', np.append(tv*1000,trace[44]*1e9).reshape(2,np.size(tv)).transpose())
np.savetxt('15ref2.dat', np.append(tv*1000,ref2[0,:]*1e9).reshape(2,np.size(tv)).transpose())
np.savetxt('15ref2+10.dat', np.append(tv*1000,ref2[0,:]*1e9+10).reshape(2,np.size(tv)).transpose())
np.savetxt('15ref2-10.dat', np.append(tv*1000,ref2[0,:]*1e9-10).reshape(2,np.size(tv)).transpose())
np.savetxt('15ref1+10.dat', np.append(tv*1000,ref[0,:]*1e9+10).reshape(2,np.size(tv)).transpose())
np.savetxt('15ref1-10.dat', np.append(tv*1000,ref[0,:]*1e9-10).reshape(2,np.size(tv)).transpose())
